...
What should you as the Scrum Master do? (Choose 1)

* [ ] A) Add the feature as a Sprint Backlog item in the current Sprint
* [ ] B) Cancel the Sprint and have the team work on this important feature
* [ ] C) Have the Product Owner speak with the CEO
* [ ] D) Have the Product Owner add the feature to the current Sprint Backlog
