...
=== The Sprint Goal Never Changes After Planning
...
The correct answer here is D - to just keep working towards the Sprint Goal. 
...
TIP: Developers wholly control the Sprint Backlog. Only the Scrum Developers can add to it or delete from it. However, the Sprint Goal can't change during the Sprint.
