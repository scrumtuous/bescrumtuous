...
* [ ] B) Software developers should only build core features and then allow other to take care of non-functional aspects.
...
* [ ] D) Coach the developers around strategies of how to fix it
...
****
Who is accountable for the creation of a useful Increment eash Sprint? (Choose 1)
