...
.The five Scrum values are: commitment, focus, openness, respect and courage. The Scrum pillars are transparency, inspection and adaptation.
...
Without transparency, it is impossible to know exactly what is happening throughout the development process. This destroys trust, makes honest inspection impossible and prompts management to want to micro-mange developers.
