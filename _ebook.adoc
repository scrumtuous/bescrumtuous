...
include::00A-sal-foreward.adoc[]

include::01B-definition-of-scrum.adoc[] 
...
include::18A-part2.adoc[]

include::19A-exam-1.adoc[]

include::20A-exam-2.adoc[]
...
'''
[.text-center]
When the student is _truly_ ready, the teacher will disappear. {nbsp} +
_Tao Te Ching_
