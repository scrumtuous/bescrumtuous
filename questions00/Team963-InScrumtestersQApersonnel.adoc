...
[#explanation]
--
Everyone on a Scrum Team that is contributing towards building out Product Backlog items and helping to meet the Definition of Done is considered developer.
--
