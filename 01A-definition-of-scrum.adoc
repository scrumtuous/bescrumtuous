...
* [ ] B) Scrum is an Agile process for teams and organizations to following
...
TIP: Waterfall gets its name from the fact that isolated development stages like planning and design flow down, into each other, in only one direction, just like water in a waterfall.
