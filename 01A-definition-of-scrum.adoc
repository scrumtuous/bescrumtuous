...
TIP: It often helps to think about certification exam questions outside of the software development domain. Think of a question in terms of building a house or building a shelter on a deserted island and answers may become more clear.
