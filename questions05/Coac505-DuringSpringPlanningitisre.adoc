...
[#query]
--
During Sprint Planning, it is realized that the highest-priority Product Backlog item cannot be completed in the Sprint being planned due to problems with an external dependency. What should the developers do?
--

[#list]
--
* [ ] Tell the Product Owner to reorder the backlog
* [*] Choose lower priority items Product Backlog items to add to the Sprint Backlog during the Sprint Planning meeting
