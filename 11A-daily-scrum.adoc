...
It's hard to think someone could argue that any of these meeting are bad. These activities just naturally elute from any team that's serious about software development.
