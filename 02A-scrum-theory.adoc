...
.Scrum development is iterative and each Sprint brings incremental progress.
...
* [ ] A new Sprint begins when Sprint Planning is completed
* [ ] A new Sprint begins when the Sprint Review is completed
* [ ] A new Sprint begins when the Product Owner begins the Sprint in JIRA
* [ ] A new Sprint begins after Sprint Planning when the Scrum Master declares the start of the Sprint
