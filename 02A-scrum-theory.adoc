...
Part of passing the Scrum Master certification exam is to first forget everything you _think_ you know about Scrum, and then focus on the core concepts contained within the Scrum Guide. That's why you won't hear me talking about the Agile Manifest- or discussing _story points_ in this book. Other Scrum Master certification exam books invest a lot of time in those topics, but I think that does you a disservice.
